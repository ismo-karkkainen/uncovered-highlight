...
- **Flexible Highlighting**: Supports dark mode, light mode, and bold-only highlighting
...
5. **Terminal Output**: Source code is displayed with uncovered parts highlighted using ANSI color codes
